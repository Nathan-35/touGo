...
class GuideSignUpVC: UIViewController, UITextFieldDelegate, UIViewControllerTransitioningDelegate, UINavigationControllerDelegate {
    
    private var imageView = UIImageView()
    private var image = UIImage(named: "Authorization3.0")
    private var emailTextField = ShakeTextField()
    private var passwordTextField = ShakeTextField()
    private var avatarButton = UIButton()
    private var nameLabel = UILabel()
    private var passwordLabel = UILabel()
    private var purpleColor = #colorLiteral(red: 0.9338529706, green: 0.4355716109, blue: 0.291136384, alpha: 1).cgColor
    private var signUpLabel = UILabel()
    private var signUpButton = UIButton()
    private var forgotButton = UIButton()
    private var mainColor = #colorLiteral(red: 0.9338529706, green: 0.4355716109, blue: 0.291136384, alpha: 1)
    ...
    private func createSignUpButton() {
        ...
        //signUpButton.addTarget(self, action: #selector(popSignUp), for: .touchUpInside)
    ...
    private func createNextButton() {
        ...
        avatarButton.setImage(UIImage(named: "addUser-4"), for: .normal)
...
extension GuideSignUpVC : UIImagePickerControllerDelegate {
    ...
    func imagePickerController(_ picker: UIImagePickerController, didFinishPickingMediaWithInfo info: [UIImagePickerController.InfoKey : Any]) {
        avatarButton.setImage(info[.editedImage] as? UIImage, for: .normal)
        avatarButton.contentMode = .scaleAspectFill
        avatarButton.clipsToBounds = true
        
//        imageIsChanged = true
        
        dismiss(animated: true) // без этого свойства контроллер выбора изображения не уйдет
    }
